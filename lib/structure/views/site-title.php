...
<p class="site-title" itemprop="headline">
	<a href="<?php echo esc_url( $url ); ?>" title="<?php echo esc_html( $site_title ); ?>">
		...
		<img class="site-title--avatar animated bounceInDown" src="<?php echo get_theme_url(); ?>/assets/images/hellofromtonya.jpg" width="50" height="50" alt="<?php echo esc_html( $site_title ); ?>">
	</a>
</p>
